...
final class EntryEqualsToTest extends TestCase
{
    ...
    public function test_that_integer_entry_is_equals_to_other_integer() : void
    {
        ...
        $this->assertFalse($filter(Row::create(new Row\Entry\IntegerEntry('integer-entry', 404))));
        $this->assertTrue($filter(Row::create(new Row\Entry\IntegerEntry('integer-entry', 200))));
    }
    ...
    public function test_float_entry_not_equals() : void
    {
        ...
        $this->assertTrue($filter(Row::create(new Row\Entry\FloatEntry('float-entry', 1.0001003))));
        $this->assertFalse($filter(Row::create(new Row\Entry\FloatEntry('float-entry', 1.0002003))));
    }
    ...
    public function test_float_entry_equals_to_not_numeric() : void
    {
        ...
        $this->assertFalse($filter(Row::create(new Row\Entry\FloatEntry('float-entry', 1.0001003))));
    }
    ...
    public function test_float_entry_equals_to_numeric() : void
    {
        ...
        $this->assertTrue($filter(Row::create(new Row\Entry\StringEntry('float-entry', '10.01'))));
    }
    ...
    public function test_float_entry_equals_to_integer() : void
    {
        ...
        $this->assertTrue($filter(Row::create(new Row\Entry\IntegerEntry('float-entry', 10))));
    }
    ...
    public function test_float_entry_equals_float() : void
    {
        ...
        $this->assertFalse($filter(Row::create(new Row\Entry\StringEntry('float-entry', 'test'))));
    }
}
