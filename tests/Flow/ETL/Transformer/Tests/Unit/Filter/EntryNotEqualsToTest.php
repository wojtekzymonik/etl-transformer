...
final class EntryNotEqualsToTest extends TestCase
{
    public function test_that_string_entry_is_not_equals_to_other_string() : void
    {
        ...
        $this->assertTrue($filter(Row::create(Row\Entry\StringEntry::lowercase('test-entry', 'not-same-value'))));
    ...
    public function test_that_integer_entry_is_not_equals_to_other_integer() : void
    {
        ...
        $this->assertTrue($filter(Row::create(new Row\Entry\IntegerEntry('integer-entry', 404))));
        $this->assertFalse($filter(Row::create(new Row\Entry\IntegerEntry('integer-entry', 200))));
    }
    ...
    public function test_float_entry_not_equals() : void
    {
        ...
        $this->assertTrue($filter(Row::create(new Row\Entry\FloatEntry('float-entry', 1.0002003))));
    }
